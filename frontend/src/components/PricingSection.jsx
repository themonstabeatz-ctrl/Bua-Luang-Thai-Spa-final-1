  ...
  return (
    ...
    >
      <div className="relative max-w-4xl mx-auto px-6 sm:px-10">
        <div className="rounded-[28px] bg-[rgba(253,250,243,0.92)] backdrop-blur-xl border border-[rgba(161,122,53,0.25)] shadow-[0_30px_80px_rgba(20,12,4,0.45)] px-6 sm:px-10 lg:px-14 py-14 sm:py-18">
