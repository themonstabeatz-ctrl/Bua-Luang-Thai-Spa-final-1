...
const WA_URL = `https://wa.me/${PHONE_RAW}?text=${encodeURIComponent(
  "Zdravo Bua Luang Thai Spa, želeo bih da zakažem termin."
)}`;
const VIBER_URL = `viber://chat?number=%2B${PHONE_RAW}`;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`absolute bottom-20 right-0 w-[300px] origin-bottom-right rounded-2xl border border-[rgba(161,122,53,0.30)] bg-white/95 backdrop-blur-xl shadow-[0_24px_60px_rgba(60,40,18,0.22)] p-3 transition-all duration-300 ${
          open
      ...
      >
        ...
        <a
          ...
          className="mt-2 flex items-center gap-3 px-4 py-3 rounded-xl border border-[rgba(161,122,53,0.20)] bg-gradient-to-r from-[#fbf6ec] to-white hover:border-[#a17a35] hover:shadow-[0_8px_24px_rgba(161,122,53,0.18)] transition-all group"
        >
      ...
      >
        <span
          className={`absolute inset-0 rounded-full bg-[#c9a45a] opacity-50 animate-ping ${
            open ? "hidden" : ""
          }`}
        />
