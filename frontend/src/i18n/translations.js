  ...
  sr: {
    ...
    contact: {
      ...
      form: {
        ...
        dateLabel: "Datum zakazivanja",
        timeLabel: "Vreme zakazivanja",
        datePlaceholder: "Izaberite datum",
        timePlaceholder: "Izaberite vreme",
        slotsLabel: "Dostupni termini",
        slotsPickDate: "Prvo izaberite datum kako bismo prikazali slobodne termine.",
        slotsLoading: "Učitavanje termina…",
        slotsEmpty: "Za izabrani datum nema slobodnih termina. Izaberite drugi dan.",
        slotBusy: "Zauzeto",
        slotNote: "Posle svakog termina sledi obavezna pauza od 30 minuta. Poslednje zakazivanje je u 21:00.",
        slotTaken: "Nažalost, taj termin je upravo zauzet. Izaberite drugi.",
        noPayment: "Bez online plaćanja — rezervacija je besplatna, a plaćanje je isključivo u salonu. Za sve dodatne informacije kontaktirajte nas:",
        message: "Poruka",
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        slotsPickDate: "Select a date first so we can show the free slots.",
        slotsLoading: "Loading slots…",
        slotsEmpty: "No free slots for the selected date. Please choose another day.",
        slotBusy: "Booked",
        slotNote: "A mandatory 30-minute break follows every appointment. Last booking starts at 21:00.",
        slotTaken: "Sorry, that slot has just been taken. Please pick another one.",
        noPayment: "No online payment — the reservation is free and payment is made at the salon. For any question, contact us:",
        message: "Message",
        submit: "Send message",
        callUs: "Call us",
        sending: "Sending...",
  ...
  ru: {
    ...
    contact: {
      ...
      form: {
        ...
        slotsPickDate: "Сначала выберите дату, чтобы увидеть свободное время.",
        slotsLoading: "Загрузка времени…",
        slotsEmpty: "На выбранную дату свободного времени нет. Выберите другой день.",
        slotBusy: "Занято",
        slotNote: "После каждого сеанса обязательный перерыв 30 минут. Последняя запись — в 21:00.",
        slotTaken: "К сожалению, это время только что заняли. Выберите другое.",
        noPayment: "Онлайн-оплаты нет — бронирование бесплатное, оплата в салоне. По любым вопросам свяжитесь с нами:",
        message: "Сообщение",
        submit: "Отправить",
  ...
  zh: {
    ...
    contact: {
      ...
      form: {
        ...
        slotsLabel: "可预约时段",
        slotsPickDate: "请先选择日期,以便显示可预约时段。",
        slotsLoading: "正在加载时段…",
        slotsEmpty: "所选日期没有可预约时段,请选择其他日期。",
        slotBusy: "已预约",
        slotNote: "每次疗程后设有 30 分钟的必要休息时间。最后可预约时间为 21:00。",
        slotTaken: "很抱歉,该时段刚刚被预订。请选择其他时段。",
        noPayment: "不支持在线支付 —— 预约免费,到店付款。如有任何疑问,请联系我们:",
        message: "留言",
        submit: "发送",
        callUs: "致电我们",
        sending: "发送中...",
  ...
  th: {
    ...
    contact: {
      ...
      form: {
        ...
        timeLabel: "เวลานัดหมาย",
        datePlaceholder: "เลือกวันที่",
        timePlaceholder: "เลือกเวลา",
        slotsLabel: "ช่วงเวลาที่ว่าง",
        slotsPickDate: "กรุณาเลือกวันที่ก่อน เพื่อแสดงช่วงเวลาที่ว่าง",
        slotsLoading: "กำลังโหลดช่วงเวลา…",
        slotsEmpty: "ไม่มีช่วงเวลาว่างในวันที่เลือก กรุณาเลือกวันอื่น",
        slotBusy: "ถูกจองแล้ว",
        slotNote: "หลังทุกการนัดหมายจะมีช่วงพักบังคับ 30 นาที การจองครั้งสุดท้ายเริ่มเวลา 21:00",
        slotTaken: "ขออภัย ช่วงเวลานี้ถูกจองไปแล้ว กรุณาเลือกช่วงเวลาอื่น",
        noPayment: "ไม่มีการชำระเงินออนไลน์ — การจองฟรี ชำระเงินที่ร้าน หากมีคำถามติดต่อเราได้ที่:",
        message: "ข้อความ",
        submit: "ส่งข้อความ",
        callUs: "โทรหาเรา",
        sending: "กำลังส่ง...",
